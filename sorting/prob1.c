...
int DeleteLamps(Data *list, int num) {
	int count = 0;
...
int dDeleteLamps(Data *list, bool* obs, int num) {
	int count = 0;
...
int main() {
	...
	int count = DeleteLamps(nodes, numOfLamps);
	QuickSort(nodes, 0, numOfLamps-1);
	IterMergeSort(nodes, numOfLamps-1);
